...
A aplicação permite realizar operações de CRUD em produtos e categorias, além de demonstrar conceitos importantes de desenvolvimento backend com Java.
...
2. git clone https://github.com/dandanilo2010/api-produtos-springboot.git
3. Entrar na pasta do projeto  cd api-produtos-springboot
4. Executar a aplicação mvn spring-boot:run
5. A aplicação irá inciar em: http://localhost:8080
